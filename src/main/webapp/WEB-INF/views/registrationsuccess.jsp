	...
	<div class="container.fluid">
		<div class="row">
			...
			<div class="col-sm-10 section">
				...
				User name : ${userDetailDto.userName}<br />
				First Name : ${userDetailDto.firstName}<br />
				Last name : ${userDetailDto.lastName}<br />
				E mail : ${userDetailDto.emailId}<br />
				Password : ${userDetailDto.password}<br /><br /><br />
